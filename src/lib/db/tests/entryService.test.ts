...
describe('EntryService', () => {
  ...
  it('should get entries for a table', async () => {
    ...
    await EntryService.createEntry({ tableId, value: 'R1', rangeStart: 1, rangeEnd: 5 });
    await EntryService.createEntry({ tableId, value: 'R2', rangeStart: 6, rangeEnd: 10 });
  ...
  it('should update an entry', async () => {
    ...
    const id = await EntryService.createEntry({ tableId, value: 'Old', rangeStart: 1, rangeEnd: 5 });
  ...
  it('should delete an entry', async () => {
    ...
    const id = await EntryService.createEntry({ tableId, value: 'Delete', rangeStart: 1, rangeEnd: 5 });
